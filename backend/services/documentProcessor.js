...
class DocumentProcessor {
  constructor() {
    this.analysisTemplates = {
      structure: {
        systemPrompt: `你是一个专业的文档结构分析专家。请分析以下产品文档的结构，识别章节组织、内容层次和整体架构。
...
4. 结构改进建议`,
      ...
      design: {
        systemPrompt: `你是一个专业的UI/UX设计专家。请分析以下产品文档中的设计缺陷，包括界面设计、用户体验和交互逻辑问题。
...
4. 具体问题描述和改进建议`,
      ...
      logic: {
        systemPrompt: `你是一个专业的逻辑分析专家。请检查以下产品文档内容的逻辑一致性和合理性。
...
4. 逻辑矛盾识别和修正建议`,
      ...
      risk: {
        systemPrompt: `你是一个专业的风险评估专家。请评估以下产品文档中描述的技术实现风险和业务影响风险。
